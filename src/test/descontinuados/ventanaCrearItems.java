...
public class ventanaCrearItems extends JFrame{
	...
	private controladorCrearItem controlador;
	...
	public ventanaCrearItems  () throws Exception{
		controlador = new controladorCrearItem(this);
	...
	private JPanel getJContentPaneCrearRepuesto() throws Exception {
		if (jContentPaneCrearRepuesto == null) {
			...
			jContentPaneCrearRepuesto.add(getJComboBoxProveedor(), null);
			...
			jButtonAceptar.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (!jTextFieldCantidad.getText().toString().isEmpty()){
						...
						//JOptionPane.showMessageDialog(jContentPaneCrearRepuesto, new ExcRepuesto().getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
					...
					if(!jTextFieldPrecio.getText().toString().isEmpty())
						...
						JOptionPane.showMessageDialog(jContentPaneCrearRepuesto, new ExcProducto().getMessage(ExcProducto.ERROR_ESPACIOS_BLANCOS), "Error", JOptionPane.ERROR_MESSAGE);
					}
					if(idFamilia == 0){
						JOptionPane.showMessageDialog(jContentPaneCrearRepuesto, ExcFamilia.FAMILIA_NOT_EXISTS, "Error", JOptionPane.ERROR_MESSAGE);
					}else{
							if(idProveedor.isEmpty()){
								JOptionPane.showMessageDialog(jContentPaneCrearRepuesto, ExcProveedores.PROVEEDOR_NOT_EXISTS, "Error", JOptionPane.ERROR_MESSAGE);
							}
							else{
							float precioIva = 0;
							...
							voProducto voData = new voProducto(1, jTextFieldNombreRepuesto.getText().toString(), idProveedor, idFamilia, "UrlFoto", cant,precioIva, precio);
							
							try {
								controlador.crearProducto(voData);
								JOptionPane.showMessageDialog(jContentPaneCrearRepuesto, ExcepcionesGeneral.OK_GUARDO, "OK", JOptionPane.INFORMATION_MESSAGE);
	...
	private JButton getJButtonCancelar() {
		if (jButtonCancelar == null) {
			...
			jButtonCancelar.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					ventanaCrearItems.this.jFrameCrearRepuesto.dispose();
